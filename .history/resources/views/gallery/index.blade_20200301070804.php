            ...
            <div class="row text-center text-lg-left">
                ...
                <div class="col-lg-3 col-md-4 col-6">
                        ...
                        <a href="/gallery/{{$album->id}}" class="d-block mb-4 h-100">
                                <img class="thumbnail" width="250px" height="250px" src="storage/gallery_covers/{{$album->cover_image}}"  alt="{{$album->name}}">
                            </a>
                    </div>
                    @endforeach
            </div>
...
<br><br>
                ...
                <form action="{{route('gallerystore')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" aria-describedby="name" placeholder="Album Name">
                    @error('name')
