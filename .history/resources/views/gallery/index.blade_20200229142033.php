                ...
                <div class="row text-center ">
                    ...
                    @if($i == $colcount)
                        ...
                        <a href="/gallery/{{$album->id}}" class="d-block mb-4 h-100">
                                <img class="thumbnail" width="500px" height="500px" src="{{asset('gallery_covers'). '/' .$album->cover_image}}"  alt="{{$album->name}}">
                            </a>
                        </div>
                        @else
                        <div class="medium-4 colums">
                            ...
                            <a href="{{route('gallery3')}}" class="d-block mb-4 h-100">
                                <img class="thumbnail" src="storage/app/public/{{$album->cover_image}}"  alt="{{$album->name}}">
                            </a>
                        </div>
                        @endif
                        @if($i % 3 == 0)
