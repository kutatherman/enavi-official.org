...
<div id="mixedSlider">
    ...
    <div class="MS-controls">
        <button class="MS-left"><i class="fa fa-angle-left" aria-hidden="true"></i>qdfqfqf</button>
        <button class="MS-right"><i class="fa fa-angle-right" aria-hidden="true"></i>qsfqfqf</button>
    </div>
</div>
</div>
 {{-- ACTUALITY END --}}
