            ...
            <div class="carousel-inner text-center" role="listbox">
                ...
                <div class="item {{ $loop->first ? ' active' : '' }}">
                    <div class="col-lg-8 pull-right">
                        <img src="{{asset('newsIMG') . '/' . $new->img}}" height="500" >
                    </div>
                    <div class="col-lg-4">                            
                        <h2>{{ $new->title }}<br>
                        ...
                        <span><a href="{{route('news.destroy', $new->id )}}" data-method="DELETE" data-confirm="Are you sure ?" class="btn btn-danger">Delete</a></span>
