...
Route::group([
    ...
    Route::get('galleryIndex0','GalleryController@galleryIndex0')->name('gallery0');
    Route::post('gallery','GalleryController@store')->name('gallerystore');
    Route::get('gallery','GalleryController@show')->name('galleryshow');
