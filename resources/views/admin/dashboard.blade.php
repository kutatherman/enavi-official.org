...
<div class="col-md-2"></div>
            ...
            <form action="{{route('postStore')}}" method="POST" novalidate role="form" enctype="multipart/form-data">
                ...
                @csrf
            	<legend class="text-center">Create board of director</legend>
                <div class="row">
        ...
        <div class="row">
            <div class="col-md-2"></div>
            <div class="col-md-8 card">
                <form action="{{route('staffStore')}}" method="POST" novalidate role="form" enctype="multipart/form-data">

                    @csrf
                    <legend class="text-center">Create staff member</legend>
                    <div class="row">
                        <div class="form-group col-md-4">
                            <label for="">Name <span class="text-danger" >*</span></label>
                            <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" required value="{{old('name')}}">
